...
function UploadedReportTabularView(props) {
  ...
  useEffect(() => {
    if (props.canUndo) {
      ...
      // Set a timer to hide the button after 10 seconds
                  ...
                  <div className="col-12">
                    ...
                    <div className="row">
                      <div
                        ...
                        style={{ marginLeft: "20px" }}
                      >
                        {props.canReset && <button onClick={props.resetSequenceHandler}>Reset All</button>}
                        {showButton && <button onClick={props.undoHandler}>Undo </button>
}                      </div>
                      {(
                        <div className="row">
                          ...
                          {props.disable &&  <div
                            className="col-lg-1 btn-thm w-10 ma-1 flaticon-edit"
                            title="pdf zip download"
                            onClick={props.makeFieldsEditable}
                          ></div>}
                           {!props.disable && <div
                            className="col-lg-1 ma-1 btn-thm w-10"
                            title="pdf zip download"
                            onClick={props.saveHandler}
                          >Save</div>}
                          <div
                            className="col-lg-1 btn-thm w-10 ma-1 flaticon-download"
                            title="pdf zip download"
