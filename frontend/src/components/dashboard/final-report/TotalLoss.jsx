...
const TotalLoss_01 = ({
  ...
  useEffect(()=>{
    // if(TotalLossEditor === "No,As Stated by Insured."){
      setTotalLossEditor(replaceFunction("",allLabour,allNewParts,currentGst,claim,allDepreciations))
    // }
          ...
          <div className="text-end">
            ...
            >
              <Image
                ...
                src="/assets/images/1694564-200.png"
                alt="fp1.jpg"
              />
            </button>
          </div>
