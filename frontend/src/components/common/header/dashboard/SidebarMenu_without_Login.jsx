                    ...
                    <div className="top_section">
                        ...
                        <ul className="sidebar-menu">
                            ...
                            <li className="title">
                                ...
                                <ul>
                                    <li
                                        className={`treeview ${checkIsActive("/my-dashboard")
                                                ? "active"
                                                : ""
                                            }`}
                                    >
                                    ...
                                    <li
                                        className={`treeview ${checkIsActive("/add-claim")
                                                ? "active"
                                                : ""
                                            }`}
                                    >
                                    ...
                                    <li
                                        className={`treeview ${checkIsActive(
                                            `/claim-details`
                                        )
                                                ? "active"
                                                : ""
                                    ...
                                    {isBill && <li
                                        className={`treeview ${checkIsActive("/bill-creation")
                                                ? "active"
                                                : ""
                                            }`}
                                    >
                                    ...
                                    {isprint && <li
                                        className={`treeview ${isSinglePageActive(
